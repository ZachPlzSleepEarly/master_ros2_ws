...
NavigationClient::NavigationClient()
    : Node("navigation_client"), goal_accepted_(false), navigation_complete_(false), navigation_successful_(false)
{
...
void NavigationClient::goalResponseCallback(std::shared_ptr<GoalHandleNavigateToPose> goal_handle)
{
    if (!goal_handle) {
        goal_accepted_ = false;
...
void NavigationClient::feedbackCallback(GoalHandleNavigateToPose::SharedPtr goal_handle,
...
void NavigationClient::resultCallback(const GoalHandleNavigateToPose::WrappedResult& result)
{
