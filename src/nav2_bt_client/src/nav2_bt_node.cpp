...
const std::string tb_worlds_share_dir = ament_index_cpp::get_package_share_directory("nav2_bt_client");
const std::string default_location_file = tb_worlds_share_dir + "/config/map_locations.yaml";
